    ...
    <div class="page-content">
        ...
        <div class=" android-more-section">
            <div class="mdl-grid">
                ...
                <div class="mdl-cell mdl-cell--2-col mdl-cell--4-col-phone" style="text-align: center">
                    <a href="{{route('student.marks', auth::User()->id)}}" >
                ...
                <div class="mdl-card demo-card-wide-header">
                    ...
                    <div class="mdl-card__supporting-text">
                        ...
                        <span class="mdl-chip mdl-chip--deletable" style="margin-left: 2%">
                            ...
                            <span class="mdl-chip__text">&nbsp;&nbsp;Curso: <strong>{{$curso}}</strong> &nbsp; &nbsp;</span>
                        </span>
                        <span class="mdl-chip mdl-chip--deletable" style="margin-left: 2%">
                            <button type="button" class="mdl-chip__action"><i class="material-icons">account_circle</i></button>
                            <span class="mdl-chip__text">&nbsp;&nbsp;Profesor: <strong>{{$teacher->name.' '.$teacher->surname}}</strong> &nbsp; &nbsp;</span>
                        </span>
...
@section('scripts')
<script>
    //script para el manejo del tab con unidades y el contenido de cada una
    $(function () {
