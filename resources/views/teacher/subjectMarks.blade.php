        ...
        <div class=" android-more-section">
            ...
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--10-col mdl-cell--4-col-phone" >
                    <p class="article-h1">Libro de Notas</p>
                </div>
            ...
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--4-col-phone" >
                    ...
                    <span class="mdl-chip mdl-chip--deletable">
                        ...
                        <span class="mdl-chip__text">&nbsp; Asignatura: {{$pilaNotas['nombre_asig']}} &nbsp;&nbsp;</span>
                   </span>
                    <span class="mdl-chip__text"> &nbsp;</span>
                </div>
            ...
            <div class="mdl-grid">
                    <div class="mdl-cell mdl-cell--12-col mdl-cell--4-col-phone" >
                        <table id="tabla-data" class="mdl-data-table mdl-js-data-table mdl-shadow--2dp" style="width:100% !important">
                            ...
                            <tbody>
                            @foreach($pilaNotas['notas_asign'] as $nota)

                                <tr>
                                    <td> {{$nota['rut']}}</td>
                                    <td> {{$nota['nombre_estu']}}</td>
                                    <td> {{$nota['nombre_eval']}}</td>
                                    <td> {{$nota['nota']}}</td>

                                    <td>
                                        <a href="{{route('teacher.subject', $id_subject)}}">
