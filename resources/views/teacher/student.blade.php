...
@stop
@section('dialogs')
    <dialog id="dialog" class="mdl-dialog" style="width: 25%">
        ...
        <div class="android-more-section">
            ...
            <div class="mdl-grid" id="botonesTeacher">
                ...
                <div class="mdl-cell mdl-cell--3-col mdl-cell--4-col-phone">
                    <a href="{{route('teacher.annotation.list',$user->id)}}"><button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect"><i class="material-icons">ballot</i>Informe personalidad</button></a>
                </div>
                <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-phone">
                    <a href="{{route('teacher.marks.student',$user->id)}}"><button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" ><i class="material-icons">playlist_add_check</i>Notas</button></a>
                </div>
            </div>
        </div>
    </div>
