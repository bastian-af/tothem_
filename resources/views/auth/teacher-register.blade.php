        ...
        <div class=" android-more-section">
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--4-col-phone" >
                    <h1 class="article-h1"> {{ __('Registrar Profesor') }}</h1>
                </div>
            </div>
            <br>
            <br>
            <div class="mdl-grid">
                <form method="POST" enctype="multipart/form-data" action="{{ route('teacher.register.submit') }}">
                @csrf
                    ...
                    <div class="mdl-grid container mdl-grid--no-spacing" STYLE="background-color: white; border: solid 1px lightgrey">
                        ...
                        <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-phone">
                            ...
                            <!--input Job Title -->
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
                                <input class="mdl-textfield__input" type="text" id="job_title" name="job_title" >
                                <label class="mdl-textfield__label" for="job_title">Especialidad</label>
                            </div>
                            <div class="invalid-feedback">
                            ...
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
                                <input class="mdl-textfield__input" type="number" id="contacto" name="fono_contacto" >
                                <label class="mdl-textfield__label" for="contacto">Fono contacto</label>
                            </div>
                            <div class="invalid-feedback">
...
@section('scripts')
    ...
    <script>
        const divcurso= document.querySelector('.divCurso');
        $(function () {
            $("#list-switch-1").change(function () {
                if(this.checked){
                    divcurso.style.display="none";
                }else{
                    divcurso.style.display="initial";
                }
            })
        })
    </script>
