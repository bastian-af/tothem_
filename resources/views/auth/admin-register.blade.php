        ...
        <div class=" android-more-section">
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--8-col mdl-cell--4-col-phone" >
                    <h1 class="article-h1"> {{ __('Registrar Administrador') }}</h1>
                </div>
            </div>
            <br>
            <br>
            <div class="mdl-grid" >
                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.register.submit') }}">
                @csrf
                    ...
                    <div class="mdl-grid container mdl-grid--no-spacing" STYLE="background-color: white; border: solid 1px lightgrey">
                        ...
                        <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-phone">
                            ...
                            <!--input segundo nombre del administrador-->
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
                            ...
                            <!--input segundo apellido del administrador -->
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
                            ...
                            <!--input direccion del administrador -->
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
                            ...
                            <br>
                            <!--input Fecha de nacimiento del administrador -->
                            <div class="mdl-textfield text_input">
                            ...
                            @endif
                            <!--input confirmar pass del administrador -->
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
