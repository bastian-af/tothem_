        ...
        <div class=" android-more-section">
            ...
            <div class="mdl-grid">
                <div class="mdl-cell mdl-cell--6-col mdl-cell--4-col-phone" >
                    <span> <h2 class="article-h2"><i class="material-icons" >bookmark</i> Asignaturas</h2>  </span>
                </div>
            </div>
            <div class="mdl-grid">
                ...
                @else
                    @foreach($asignaturas as $asignatura)
                        <div class="mdl-grid" >
                            ...
                            <div class="mdl-grid span_info">
                                @if (!isset($asignatura['evaluaciones']) && empty($asignatura['evaluaciones']))
                                    <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-phone" style="border-color: {{$asignatura['color']}}; ">
                                        <span style="" ><i class="material-icons">dns</i>N° Evaluaciones: 0 </span>
                                    </div>

                                    <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-phone" style="border-color: {{$asignatura['color']}}; " >
                                        <span style="" ><i class="material-icons">chrome_reader_mode</i>Promedio: - </span>
                                    </div>
                                @else
                                    <div class="mdl-cell mdl-cell--4-col mdl-cell--4-col-phone" style="border-color: {{$asignatura['color']}}; ">
                                        <span style="" ><i class="material-icons">dns</i>N° Evaluaciones: {{$asignatura['cantidad']}} </span>
                                    </div>

                                    <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-phone" style="border-color: {{$asignatura['color']}}; " >
                                        <span style="" ><i class="material-icons">chrome_reader_mode</i>Promedio : {{$asignatura['promedio']}} </span>
                                    </div>
                                @endif
                            </div>
                        </div>
            ...
            <button type="button"  onclick="history.back()" class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent" style=" margin-left: 2%; ">
