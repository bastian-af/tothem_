...
@section('title')
    Editar Curso {{$curso->numero}} ° {{$curso->letra}}
@stop
...
@section('content')
    ...
    <div class="page-content">
        <div class="android-more-section">
            <h1 class="article-h1">Editar curso</h1>
        </div>
    </div>
    <div class="page-content">
        <div class=" android-more-section">
            <form method="POST" enctype="multipart/form-data" action="{{route('admin.grade.update',$curso->id)}}">
                @csrf
                <div class="mdl-grid" STYLE="background-color: white; border: solid 1px lightgrey">
                    ...
                    <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-phone">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
                            <input class="mdl-textfield__input" type="text" id="numero" name="numero" value="{{$curso->numero}}">
                    ...
                    <!--input letra Curso-->
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
                            <input class="mdl-textfield__input" type="text" id="letra" name="letra" value="{{$curso->letra}}">
