...
@section('styles')
    <style>/*CSS Imagen*/
        ...
        .container-image .mdl-card {
            background: url({{URL::asset('subject/'.$asignatura->url_imagen)}});
...
@section('content')
    <div class="page-content">
        <div class="android-more-section">
            <h1 class="article-h1">Editar Asignatura</h1>
        </div>
    </div>
    <div class="page-content">
        <div class="android-more-section">
            <!-- formulario editar asignatura  -->
            <form method="POST" enctype="multipart/form-data" action="{{route('admin.subject.update',$asignatura['id'])}}">
                @csrf
                ...
                <div class="mdl-grid" STYLE="background-color: white; border: solid 1px lightgrey">
                    ...
                    <div class="mdl-cell mdl-cell--5-col mdl-cell--4-col-phone">
                        ...
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
                            <input class="mdl-textfield__input" type="text" id="name" name="name" value="{{$asignatuta->name}}">
                    ...
                    <!--input descripcion de la asignatura-->
                        <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label text_input">
                           <input class="mdl-textfield__input" type="text" id="descripcion" name="descripcion" {{$asignatuta->descripcion}}>
